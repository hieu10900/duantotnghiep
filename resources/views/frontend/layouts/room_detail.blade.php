    ...
    <!-- Nav Bar End -->
        <div class="detail">
            ...
            <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-8 slide-img-top">
                    <div class="container"  data-aos="fade-right ">
                        <div class="slide-detail">
                            ...
                            <div class="row mr-0 mt-3 responsive">
                                    <img class="democursor pl-2 "
                                        src="{{ config('app.base_url') . $Room_detail->feature_image_path	 }}"
                                         onclick=" currentSlide(1)" alt="Cinque Terre"/>                           
                               @foreach ($Image_room as $key => $item)                                   
                                        <img class="democursor pl-2 " src="{{ config('app.base_url') . $item->image	 }}"
                ...
                <div data-aos="fade-left" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4 d-flex justify-content-center aos-init aos-animate">
